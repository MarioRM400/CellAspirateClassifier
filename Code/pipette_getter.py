...
# def crop_image_2bbxs(pipette_tip_bbx, 
#                      img, 
#                      img_name, 
#                      out_folder):
...
#             crop = img[pipette_tip_bbx[1]:cc_bbx[-1], pipette_tip_bbx[0]:cc_bbx[2]]
...
#             crop = img[cc_bbx[1]:pipette_tip_bbx[-1], pipette_tip_bbx[0]:cc_bbx[2]]
#             # crop = img[cc_bbx[1]:cc_bbx[3], cc_bbx[0]:cc_bbx[2]]
#             crop_name = os.path.join(out_folder, img_name.split(".")[0] + "-crop.jpg")
#             cv2.imwrite(crop_name, crop)
...
#         if cc_bbx[1] > pipette_tip_bbx[1]:
#             crop = img[pipette_tip_bbx[1]:cc_bbx[-1], cc_bbx[0]:pipette_tip_bbx[2]]
#             # crop = img[cc_bbx[1]:cc_bbx[3], cc_bbx[0]:cc_bbx[2]]
#             crop_name = os.path.join(out_folder, img_name.split(".")[0] + "-crop.jpg")
#             cv2.imwrite(crop_name, crop)
#         elif cc_bbx[1] < pipette_tip_bbx[1]:
#             crop = img[cc_bbx[1]:pipette_tip_bbx[-1], cc_bbx[0]:pipette_tip_bbx[2]]
#             # crop = img[cc_bbx[1]:cc_bbx[3], cc_bbx[0]:cc_bbx[2]]
#             crop_name = os.path.join(out_folder, img_name.split(".")[0] + "-crop.jpg")
#             cv2.imwrite(crop_name, crop)
...
if __name__ == "__main__":
    ...
    out_path = r"C:\Users\PC KAIJU\ConceivableProjectsTools\FrameSampler\coc_follicular_h\ARDUCAM-TIP\v2\ext\pipettes"
    in_path = r"C:\Users\PC KAIJU\ConceivableProjectsTools\FrameSampler\coc_follicular_h\ARDUCAM-TIP\v2\ext"
    ...
    for im in tqdm.tqdm(updated_image_list):
        ...
        try:
            ...
            destine_un_image = os.path.join(out_path, im.split(".")[0] + "-pipette" + ".jpg")
